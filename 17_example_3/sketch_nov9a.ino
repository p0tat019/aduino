...
#define PIN_IR    1         // IR sensor at Pin A0
#define PIN_LED   9
#define PIN_SERVO 10
...
#define LOOP_INTERVAL 50.0   // Loop Interval (unit: msec)
...
void loop()
{
  ...
  float value = constrain(dist_ema, _DIST_MIN, _DIST_MAX);
  float percentage = (value - _DIST_MIN) / (_DIST_MAX - _DIST_MIN);
  duty = _DUTY_MIN + percentage * (_DUTY_MAX - _DUTY_MIN); 
